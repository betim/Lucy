...
public class MimeType {
  ...
  public final static String defaultContentType = "text/html";
  ...
  public static String get(File file) {
    ...
    if (fileName.lastIndexOf(".") != -1 && fileName.lastIndexOf(".") != 0)
      return get(fileName.substring(fileName.lastIndexOf(".") + 1));
    else
      return defaultContentType;
  }

  public static String get(String extension) {
    return contentTypes.getProperty(extension, defaultContentType);
  }

  public static void contentType(FullHttpRequest request, HttpResponse response, File resource) {
    String substr;
